...
Windows users are recommended to install [OSGeo4W](https://trac.osgeo.org/osgeo4w/) (include QGIS option) as an easy way to obtain the required `gdal` support for Python in Windows. See `?tiler_options` for details.
