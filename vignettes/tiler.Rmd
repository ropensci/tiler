...
These map tiles were originally generated with the following code:
...
leaflet(
  options = leafletOptions(minZoom = 0, maxZoom = 7), width = "100%", height = "400px") %>% 
...
These map tiles were generated with `tile("st2.png", "tiles", "0-7")` and are hosted [here](https://github.com/leonawicz/tiles/tree/master/st2).
